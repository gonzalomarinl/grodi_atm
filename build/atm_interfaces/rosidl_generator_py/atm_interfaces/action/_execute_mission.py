    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'atm_interfaces.action.ExecuteMission_Goal')
            logger.debug(
...
class ExecuteMission_Goal(metaclass=Metaclass_ExecuteMission_Goal):
    ...
    _fields_and_field_types = {
        'mission_id': 'string',
        'mission_type': 'string',
        'line_ids': 'sequence<string>',
        'target_line_ids': 'sequence<string>',
        'stop_indices': 'sequence<uint32>',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.line_ids = kwargs.get('line_ids', [])
        self.target_line_ids = kwargs.get('target_line_ids', [])
        self.stop_indices = array.array('I', kwargs.get('stop_indices', []))
    ...
    def __eq__(self, other):
        ...
        if self.mission_type != other.mission_type:
            return False
        if self.line_ids != other.line_ids:
            return False
        if self.target_line_ids != other.target_line_ids:
            return False
        if self.stop_indices != other.stop_indices:
            return False
        return True
    ...
    @builtins.property
    def line_ids(self):
        """Message field 'line_ids'."""
        return self._line_ids

    @line_ids.setter
    def line_ids(self, value):
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'line_ids' field must be a set or sequence and each value of type 'str'"
        self._line_ids = value

    @builtins.property
    def target_line_ids(self):
        """Message field 'target_line_ids'."""
        return self._target_line_ids

    @target_line_ids.setter
    def target_line_ids(self, value):
        if self._check_fields:
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, str) for v in value) and
                 True), \
                "The 'target_line_ids' field must be a set or sequence and each value of type 'str'"
        self._target_line_ids = value

    @builtins.property
    def stop_indices(self):
        """Message field 'stop_indices'."""
        return self._stop_indices

    @stop_indices.setter
    def stop_indices(self, value):
        if self._check_fields:
            if isinstance(value, array.array):
                assert value.typecode == 'I', \
                    "The 'stop_indices' array.array() must have the type code of 'I'"
                self._stop_indices = value
                return
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            ...
            assert \
                ...
                "The 'stop_indices' field must be a set or sequence and each value of type 'int' and each unsigned integer in [0, 4294967295]"
        self._stop_indices = array.array('I', value)
...
class Metaclass_ExecuteMission_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'atm_interfaces.action.ExecuteMission_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_ExecuteMission_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'atm_interfaces.action.ExecuteMission_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ExecuteMission_SendGoal_Request(metaclass=Metaclass_ExecuteMission_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'atm_interfaces/ExecuteMission_Goal',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['atm_interfaces', 'action'], 'ExecuteMission_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from atm_interfaces.action._execute_mission import ExecuteMission_Goal
...
class ExecuteMission_SendGoal_Event(metaclass=Metaclass_ExecuteMission_SendGoal_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<atm_interfaces/ExecuteMission_SendGoal_Request, 1>',
        'response': 'sequence<atm_interfaces/ExecuteMission_SendGoal_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['atm_interfaces', 'action'], 'ExecuteMission_SendGoal_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['atm_interfaces', 'action'], 'ExecuteMission_SendGoal_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from atm_interfaces.action import ExecuteMission_SendGoal_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
    ...
    def response(self, value):
        if self._check_fields:
            from atm_interfaces.action import ExecuteMission_SendGoal_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_ExecuteMission_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'atm_interfaces.action.ExecuteMission_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from atm_interfaces.action import _execute_mission
...
class ExecuteMission_SendGoal(metaclass=Metaclass_ExecuteMission_SendGoal):
    from atm_interfaces.action._execute_mission import ExecuteMission_SendGoal_Request as Request
    from atm_interfaces.action._execute_mission import ExecuteMission_SendGoal_Response as Response
    from atm_interfaces.action._execute_mission import ExecuteMission_SendGoal_Event as Event
...
class ExecuteMission_GetResult_Response(metaclass=Metaclass_ExecuteMission_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'atm_interfaces/ExecuteMission_Result',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['atm_interfaces', 'action'], 'ExecuteMission_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from atm_interfaces.action._execute_mission import ExecuteMission_Result
...
class ExecuteMission_GetResult_Event(metaclass=Metaclass_ExecuteMission_GetResult_Event):
    ...
    _fields_and_field_types = {
        'info': 'service_msgs/ServiceEventInfo',
        'request': 'sequence<atm_interfaces/ExecuteMission_GetResult_Request, 1>',
        'response': 'sequence<atm_interfaces/ExecuteMission_GetResult_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['service_msgs', 'msg'], 'ServiceEventInfo'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['atm_interfaces', 'action'], 'ExecuteMission_GetResult_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['atm_interfaces', 'action'], 'ExecuteMission_GetResult_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from atm_interfaces.action import ExecuteMission_GetResult_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
    ...
    def response(self, value):
        if self._check_fields:
            from atm_interfaces.action import ExecuteMission_GetResult_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_ExecuteMission_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'atm_interfaces.action.ExecuteMission_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ExecuteMission_GetResult(metaclass=Metaclass_ExecuteMission_GetResult):
    from atm_interfaces.action._execute_mission import ExecuteMission_GetResult_Request as Request
    from atm_interfaces.action._execute_mission import ExecuteMission_GetResult_Response as Response
    from atm_interfaces.action._execute_mission import ExecuteMission_GetResult_Event as Event
...
class Metaclass_ExecuteMission_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'atm_interfaces.action.ExecuteMission_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ExecuteMission_FeedbackMessage(metaclass=Metaclass_ExecuteMission_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'atm_interfaces/ExecuteMission_Feedback',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['atm_interfaces', 'action'], 'ExecuteMission_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from atm_interfaces.action._execute_mission import ExecuteMission_Feedback
...
class Metaclass_ExecuteMission(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'atm_interfaces.action.ExecuteMission')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ExecuteMission(metaclass=Metaclass_ExecuteMission):
    ...
    from atm_interfaces.action._execute_mission import ExecuteMission_Goal as Goal
    # The result message defined in the action definition.
    from atm_interfaces.action._execute_mission import ExecuteMission_Result as Result
    # The feedback message defined in the action definition.
    from atm_interfaces.action._execute_mission import ExecuteMission_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from atm_interfaces.action._execute_mission import ExecuteMission_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from atm_interfaces.action._execute_mission import ExecuteMission_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from atm_interfaces.action._execute_mission import ExecuteMission_FeedbackMessage as FeedbackMessage
