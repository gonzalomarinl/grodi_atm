...
bool atm_interfaces__msg__fault_report__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("atm_interfaces.msg._fault_report.FaultReport", full_classname_dest, 44) == 0);
  }
  atm_interfaces__msg__FaultReport * ros_message = _ros_message;
  {  // mission_id
  ...
  {  // fault_code
    ...
    rosidl_runtime_c__String__assign(&ros_message->fault_code, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // severity
  ...
  {  // requires_return_home
    PyObject * field = PyObject_GetAttrString(_pymsg, "requires_return_home");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->requires_return_home = (Py_True == field);
    Py_DECREF(field);
  }
  {  // stamp
...
{
  /* NOTE(esteve): Call constructor of FaultReport */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("atm_interfaces.msg._fault_report");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FaultReport");
  ...
  {  // fault_code
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->fault_code.data,
      strlen(ros_message->fault_code.data),
      "replace");
    if (!field) {
      return NULL;
    }
  ...
  {  // requires_return_home
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->requires_return_home ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "requires_return_home", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
