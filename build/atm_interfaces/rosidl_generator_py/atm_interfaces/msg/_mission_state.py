    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'atm_interfaces.msg.MissionState')
            logger.debug(
...
class MissionState(metaclass=Metaclass_MissionState):
    ...
    def __init__(self, **kwargs):
        ...
        self.comms_degraded = kwargs.get('comms_degraded', bool())
        from builtin_interfaces.msg import Time
    ...
    def __eq__(self, other):
        ...
        if self.current_line_id != other.current_line_id:
            return False
        if self.comms_degraded != other.comms_degraded:
            return False
    ...
    @builtins.property
    def comms_degraded(self):
        """Message field 'comms_degraded'."""
        return self._comms_degraded

    @comms_degraded.setter
    def comms_degraded(self, value):
        if self._check_fields:
            assert \
                isinstance(value, bool), \
                "The 'comms_degraded' field must be of type 'bool'"
        self._comms_degraded = value
