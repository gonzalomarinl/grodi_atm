...
static const _StartPump_Request_type_support_symbol_names_t _StartPump_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, atm_interfaces, srv, StartPump_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, atm_interfaces, srv, StartPump_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, atm_interfaces, srv, StartPump_Request)() {
  return &::atm_interfaces::srv::rosidl_typesupport_c::StartPump_Request_message_type_support_handle;
}
...
static const _StartPump_Response_type_support_symbol_names_t _StartPump_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, atm_interfaces, srv, StartPump_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, atm_interfaces, srv, StartPump_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, atm_interfaces, srv, StartPump_Response)() {
  return &::atm_interfaces::srv::rosidl_typesupport_c::StartPump_Response_message_type_support_handle;
}
...
static const _StartPump_Event_type_support_symbol_names_t _StartPump_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, atm_interfaces, srv, StartPump_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, atm_interfaces, srv, StartPump_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, atm_interfaces, srv, StartPump_Event)() {
  return &::atm_interfaces::srv::rosidl_typesupport_c::StartPump_Event_message_type_support_handle;
}
...
static const _StartPump_type_support_symbol_names_t _StartPump_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, atm_interfaces, srv, StartPump)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, atm_interfaces, srv, StartPump)),
  }
};
...
static const rosidl_service_type_support_t StartPump_service_type_support_handle = {
  ...
  &StartPump_Request_message_type_support_handle,
  &StartPump_Response_message_type_support_handle,
  &StartPump_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, atm_interfaces, srv, StartPump)() {
  return &::atm_interfaces::srv::rosidl_typesupport_c::StartPump_service_type_support_handle;
}
