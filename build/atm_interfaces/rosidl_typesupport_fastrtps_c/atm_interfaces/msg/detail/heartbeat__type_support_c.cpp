...
#include "atm_interfaces/msg/detail/heartbeat__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // machine_id, node_name, state
#include "rosidl_runtime_c/string_functions.h"  // machine_id, node_name, state
...
using _Heartbeat__ros_msg_type = atm_interfaces__msg__Heartbeat;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_atm_interfaces
bool cdr_serialize_atm_interfaces__msg__Heartbeat(
  const atm_interfaces__msg__Heartbeat * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_runtime_c__String * str = &ros_message->machine_id;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_atm_interfaces
bool cdr_deserialize_atm_interfaces__msg__Heartbeat(
  eprosima::fastcdr::Cdr & cdr,
  atm_interfaces__msg__Heartbeat * ros_message)
{
  // Field name: node_name
  {
    std::string tmp;
  ...
  // Field name: machine_id
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->machine_id.data) {
      rosidl_runtime_c__String__init(&ros_message->machine_id);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->machine_id,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'machine_id'\n");
      return false;
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_atm_interfaces
size_t get_serialized_size_atm_interfaces__msg__Heartbeat(
  const void * untyped_ros_message,
  size_t current_alignment)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_atm_interfaces
size_t max_serialized_size_atm_interfaces__msg__Heartbeat(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = atm_interfaces__msg__Heartbeat;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_atm_interfaces
bool cdr_serialize_key_atm_interfaces__msg__Heartbeat(
  const atm_interfaces__msg__Heartbeat * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: node_name
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_atm_interfaces
size_t get_serialized_size_key_atm_interfaces__msg__Heartbeat(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Heartbeat__ros_msg_type * ros_message = static_cast<const _Heartbeat__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_atm_interfaces
size_t max_serialized_size_key_atm_interfaces__msg__Heartbeat(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const atm_interfaces__msg__Heartbeat * ros_message = static_cast<const atm_interfaces__msg__Heartbeat *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_atm_interfaces__msg__Heartbeat(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  atm_interfaces__msg__Heartbeat * ros_message = static_cast<atm_interfaces__msg__Heartbeat *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_atm_interfaces__msg__Heartbeat(cdr, ros_message);
}

static uint32_t _Heartbeat__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_atm_interfaces__msg__Heartbeat(
...
static size_t _Heartbeat__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_atm_interfaces__msg__Heartbeat(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, atm_interfaces, msg, Heartbeat)() {
