...
#include "atm_interfaces/msg/detail/mission_event__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // detail, event_type, mission_id, source
#include "rosidl_runtime_c/string_functions.h"  // detail, event_type, mission_id, source
...
using _MissionEvent__ros_msg_type = atm_interfaces__msg__MissionEvent;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = atm_interfaces__msg__MissionEvent;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const atm_interfaces__msg__MissionEvent * ros_message = static_cast<const atm_interfaces__msg__MissionEvent *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_atm_interfaces__msg__MissionEvent(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  atm_interfaces__msg__MissionEvent * ros_message = static_cast<atm_interfaces__msg__MissionEvent *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_atm_interfaces__msg__MissionEvent(cdr, ros_message);
}

static uint32_t _MissionEvent__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_atm_interfaces__msg__MissionEvent(
...
static size_t _MissionEvent__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_atm_interfaces__msg__MissionEvent(
