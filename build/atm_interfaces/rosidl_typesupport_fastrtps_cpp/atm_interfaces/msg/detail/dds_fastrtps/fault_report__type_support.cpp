...
#include "atm_interfaces/msg/detail/fault_report__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const atm_interfaces::msg::FaultReport & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  atm_interfaces::msg::FaultReport & ros_message)
{
  // Member: mission_id
  cdr >> ros_message.mission_id;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_atm_interfaces
max_serialized_size_FaultReport(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = atm_interfaces::msg::FaultReport;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_atm_interfaces
max_serialized_size_key_FaultReport(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const atm_interfaces::msg::FaultReport *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<atm_interfaces::msg::FaultReport *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FaultReport__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const atm_interfaces::msg::FaultReport *>(
...
static size_t _FaultReport__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FaultReport(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FaultReport__callbacks = {
  "atm_interfaces::msg",
  "FaultReport",
...
static rosidl_message_type_support_t _FaultReport__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FaultReport__callbacks,
...
{
  return &atm_interfaces::msg::typesupport_fastrtps_cpp::_FaultReport__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, atm_interfaces, msg, FaultReport)() {
  return &atm_interfaces::msg::typesupport_fastrtps_cpp::_FaultReport__handle;
}
