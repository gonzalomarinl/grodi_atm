...
#include "atm_interfaces/msg/detail/mission_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const atm_interfaces::msg::MissionState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  atm_interfaces::msg::MissionState & ros_message)
{
  // Member: mission_id
  cdr >> ros_message.mission_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = atm_interfaces::msg::MissionState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const atm_interfaces::msg::MissionState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<atm_interfaces::msg::MissionState *>(
    untyped_ros_message);
...
{
  return &atm_interfaces::msg::typesupport_fastrtps_cpp::_MissionState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, atm_interfaces, msg, MissionState)() {
  return &atm_interfaces::msg::typesupport_fastrtps_cpp::_MissionState__handle;
}
