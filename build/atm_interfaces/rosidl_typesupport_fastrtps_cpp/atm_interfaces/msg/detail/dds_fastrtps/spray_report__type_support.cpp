...
#include "atm_interfaces/msg/detail/spray_report__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = atm_interfaces::msg::SprayReport;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const atm_interfaces::msg::SprayReport *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<atm_interfaces::msg::SprayReport *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SprayReport__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const atm_interfaces::msg::SprayReport *>(
...
static size_t _SprayReport__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SprayReport(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SprayReport__callbacks = {
  "atm_interfaces::msg",
  "SprayReport",
...
static rosidl_message_type_support_t _SprayReport__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SprayReport__callbacks,
...
{
  return &atm_interfaces::msg::typesupport_fastrtps_cpp::_SprayReport__handle;
}
