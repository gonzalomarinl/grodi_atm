...
setup(
    ...
    data_files=[
        ...
        (
            ...
            [
                ...
                "launch/atomizer_real_stack.launch.py",
            ],
        ),
        ("share/" + package_name + "/config", ["config/simulation_params.yaml"]),
    ...
    description="Simulacion Gazebo ligera del atomizador sobre rail.",
    license="MIT",
    extras_require={
        "test": [
            "pytest",
    ...
    entry_points={
        "console_scripts": [
            ...
            "sim_command_cli = atm_simulation.sim_command_cli:main",
            "real_stack_visualizer_node = atm_simulation.real_stack_visualizer_node:main",
            "real_stack_operator_console_node = atm_simulation.real_stack_operator_console_node:main",
        ],
    },
)
